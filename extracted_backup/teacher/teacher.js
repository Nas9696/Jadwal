...
function renderHeader() {
    ...
    byId('header-teacher').textContent = state.teacherName ? `������: ${state.teacherName}` : '��� ��� ������ �� ���� ������';
...
function updateTimer() {
    ...
    if (status.current) {
        ...
        byId('next-task').textContent = status.next ? `������: ${status.next.subject}` : '��� ��� ��� �����';
        ...
        byId('current-task').textContent = '������ �����';
        byId('next-task').textContent = `������: ${status.next.subject}`;
        byId('countdown').textContent = window.formatDuration(status.remainingSeconds);
        byId('timer-progress').style.strokeDashoffset = 377;
    } else {
        byId('current-task').textContent = '���� ��� �����';
        byId('next-task').textContent = '�� ���� ��� ����� �����';
...
window.shareWhatsApp = () => {
    const lines = [`���� ${state.teacherName || '������'} - ${stage().label}`, ''];
    DAYS.forEach(day => {
