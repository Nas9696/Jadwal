...
كل `PeriodTemplate` مرتبط صراحة بمدرسة و`WeekPattern` من المدرسة نفسها، ويحمل نمط الأسبوع `cycle_week_index` قابلًا للمقارنة في دورة A/B/C. عقود المحرك تحمل المدرسة وحدود الدقائق الفعلية؛ تعارض المعلم المشترك يعتمد على تداخل `[starts_at_minute, ends_at_minute)` في الأسبوع الدوري واليوم نفسيهما، وليس على رقم الحصة أو نمط الحضور.
